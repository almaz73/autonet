	...
	build: {
		rollupOptions: {
			input: {
				...
				p660789: resolve(__dirname, './promo/660789/index.html'),
				...
				n657189: resolve(__dirname,'./news/657189/index.html'),
				n657190: resolve(__dirname,'./news/657190/index.html'),
				n657191: resolve(__dirname,'./news/657191/index.html'),
				n657192: resolve(__dirname,'./news/657192/index.html'),
				n657193: resolve(__dirname,'./news/657193/index.html'),
