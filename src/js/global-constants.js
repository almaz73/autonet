...
export const cities = ['Альметьевск', 'Астрахань', 'Бугульма', 'Буинск',
...
export const vacanciesList = [
    // {
    //     vacancyName:'Кредитный специалист',
    //     id:1,
    //     salary:'70000',
    //     city:'Казань',
    //     content: ` <strong>Обязанности:</strong>
    //             <ul>
...
export const enToRu = {
    'q':'й','w':'ц','e':'у','r':'к','t':'е','y':'н','u':'г','i':'ш','o':'щ','p':'з','[':']',']':'ъ',
    'a':'ф','s':'ы','d':'в','f':'а','g':'п','h':'р','j':'о','k':'л','l':'д',';':'ж','\'':'э',
    'z':'я','x':'ч','c':'с','v':'м','b':'и','n':'т','m':'ь',',':',','.':'.'
};

export const ruToEn = {
    'й': 'q', 'ц': 'w', 'у': 'e', 'к': 'r', 'е': 't', 'н': 'y', 'г': 'u', 'ш': 'i', 'щ': 'o', 'з': 'p', ']': '[', 'ъ': ']',
