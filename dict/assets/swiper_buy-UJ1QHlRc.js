import{i}from"./swiper-starter-BnUg_gOD.js";document.addEventListener("DOMContentLoaded",()=>{window.reloadLittleSwiper()});window.reloadLittleSwiper=function(){let s=document.querySelector("swiper_buy");if(!s)return!1;s.innerHTML=l,setTimeout(i,2e3)};let l=`
