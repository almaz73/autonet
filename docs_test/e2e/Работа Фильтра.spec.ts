...
// ... existing code ...
test('Фильтр "Год от" "Год до"', async ({page}) => {
    await page.goto(testPath+'/cars/');
...
test('Фильтр "Цена от" "Цена до"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
...
test('Фильтр "Пробег от" "Пробег до"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000); // Wait for filter to apply
...
test('Фильтр "Объем двигателя до"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000); // Wait for filter to apply
...
test('Фильтр  "Тип кузова"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000);
...
test('Фильтр  "Тип КПП"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000);
...
test('Фильтр  "Тип двигателя"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000);
...
test('Фильтр  "Тип привода"', async ({page}) => {
    await page.goto(testPath+'/cars/');
    await page.locator('.frame-filter__controls-advanced-text').click();
    await page.waitForTimeout(1000);
