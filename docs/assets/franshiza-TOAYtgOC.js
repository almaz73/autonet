import{i as a}from"./main-CPRaK-1U.js";/* empty css                *//* empty css                */console.log("franshiza.js ----");document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".question_to_boss"),l=document.querySelector(".count_business_plan"),o=document.querySelector("#right_panel_content"),r=document.querySelector(".who_can_become_partner"),t=`<div class="promo-detail-call__wrap">
    <div class="div">
...
</div>`;e&&e.addEventListener("click",s=>{openRightPanel(),o.innerHTML=t,a()}),l.addEventListener("click",()=>{openRightPanel(),o.innerHTML=i,a()}),r.addEventListener("click",()=>{openRightPanel(),o.innerHTML=i,a()})});
