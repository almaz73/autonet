(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const c of r)if(c.type==="childList")for(const n of c.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function a(r){const c={};return r.integrity&&(c.integrity=r.integrity),r.referrerPolicy&&(c.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?c.credentials="include":r.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function o(r){if(r.ep)return;r.ep=!0;const c=a(r);fetch(r.href,c)}})();let f=document.querySelector(".comb__items"),P=document.querySelector(".comb_field"),F=document.querySelector(".comb__selected"),G=document.querySelector(".footer-city-button"),T=document.querySelector("#city-contacts"),M=document.querySelector(".comb_field img"),C=document.querySelector(".mySwiper"),J=localStorage.getItem("selectedCity");P&&(F.innerHTML=J||"Россия",document.addEventListener("click",()=>O(!1)),P.addEventListener("click",e=>Q(e)),f.addEventListener("click",e=>N(e)));function N(e){let t=e.target.innerText;if(t.length>30)return!1;F.innerHTML=G.innerHTML=t,T&&(T.innerHTML=t),localStorage.setItem("selectedCity",t),window.setCity&&window.setCity(t)}function Q(e){O(f.style.display!=="block"),e.stopPropagation()}function O(e){f&&(f.style.display=e?"block":"none"),M&&(M.style.rotate=e?"180deg":"0deg"),C&&(C.style.zIndex=e?-1:0)}let W=document.querySelector("#innerCity"),y=document.querySelector(".form__modal-place--group input"),K=["Альметьевск","Астрахань","Бугульма","Буинск","Екатеринбург","Казань","Магнитогорск","Набережные Челны","Нижнекамск","Нижний Тагил","Оренбург","Самара","Саранск","Стерлитамак","Тольятти","Тула","Ульяновск","Уфа"],Y=["А","Б","Е","К","М","Н","О","С","Т","У"];function j(e){let t="";Y.forEach(a=>{let o=K.filter(c=>c.slice(0,1)===a),r="";o.forEach(c=>{let n=e&&c.toUpperCase().includes(e)?" class='yel'":"";r+=`<li><a href="javascript:void(0)" onclick="setCity('${c}')"><span ${n}>${c}</span></a></li>`}),t+=`<div class="modal-place__box">
<div><div class="letter">${a}</div><ul>${r}</ul></div></div>`}),W.innerHTML=t}y&&y.addEventListener("input",e=>{j(y.value.toUpperCase())});let X=document.querySelector(".button__burger"),v=document.querySelector(".main-nav.menu"),h=document.querySelector(".button__burger"),l=document.querySelector(".main-nav.cities"),B=document.querySelector(".footer-city-button"),H=document.querySelector("#city-contacts"),z=document.querySelector(".modal-place__close"),I=document.querySelector(".mySwiper"),i,b=document.querySelector(".main-nav.rightpanel"),D=document.querySelector("#closer-fon"),$=document.querySelector(".modal-closer.form");I&&(I.style.zIndex=0);X&&X.addEventListener("click",()=>{if(i)return i=!1,l.style.transform="translateX(150vw)",!1;i=v.style.transform!=="none",v.style.transform=i?"none":"translateX(150vw)",i?(h.classList.add("close"),i=!1):h.classList.remove("close")});B&&B.addEventListener("click",()=>U());H&&H.addEventListener("click",()=>U());function U(){i=l.style.transform!=="none",i&&(l.style.transform="none",l.style.backgroundColor="white"),j()}z&&z.addEventListener("click",()=>{l.style.transform="translateX(150vw)"});let R=document.querySelector("#cookie-accept"),w=document.querySelector("#cookie-banner"),Z=localStorage.getItem("isCoockieBannerShow");!Z&&w&&w.classList.add("show");R&&R.addEventListener("click",()=>{localStorage.setItem("isCoockieBannerShow",new Date().toISOString()),w.classList.remove("show")});function _(e){b&&(b.style.transform="translateX(150vw)"),l&&(l.style.transform="translateX(150vw)"),v&&(v.style.transform="translateX(150vw)"),h&&h.classList.remove("close"),closeChat()}window.close_all=_;document.addEventListener("keydown",e=>e.key==="Escape"&&_());window.openRightPanel=function(){i=b.style.transform!=="none",i&&(b.style.transform="none")};D&&D.addEventListener("click",()=>_());$&&$.addEventListener("click",()=>_());const d=document.getElementById("mainPhoto");d&&d.addEventListener("click",function(){if(window.innerWidth<900)return!1;d.requestFullscreen?d.requestFullscreen():d.mozRequestFullScreen?d.mozRequestFullScreen():d.webkitRequestFullscreen?d.webkitRequestFullscreen():d.msRequestFullscreen&&d.msRequestFullscreen()});let q=document.querySelector(".question_block"),u=document.querySelector(".question_panel .contentedit div"),k=document.querySelector(".question_panel .history");window.openChat=function(e,t){if(e.stopPropagation(),t==="no")return e.stopPropagation();(!t||window.innerWidth>500)&&(q.style.display="block"),k.scrollTo(0,1e4)};window.closeChat=function(e){q&&(q.style.display="none")};u&&u.addEventListener("keydown",e=>{e.code==="Enter"&&(k.innerHTML+="<b>-Вы </b>"+u.innerHTML+"<br><br>",k.scrollTo({top:1e4,behavior:"smooth"}),ee(u.innerHTML),setTimeout(()=>u.innerHTML=""))});function ee(e){let o=`https://api.telegram.org/bot8235288635:AAF_soJaYR8OPHAQrpfcF4FDUr2JjRRDlVw/sendMessage?chat_id=-5064627941&parse_mode=HTML&text=${e}`;fetch(o).then(r=>r.json()).then(()=>{console.log("сообщение доставлено = ")})}document.addEventListener("DOMContentLoaded",()=>{window.reloadAbdul()});window.reloadAbdul=function(){let e=document.querySelector("abdul");e&&(e.innerHTML=te)};const te=`
...
`;let ie=document.querySelector(".global-call"),p=document.querySelector("#right_panel_content");ie.addEventListener("click",()=>{openRightPanel(),p.innerHTML=de,V()});window.glob_call=function(){let e=p.querySelector(".capctha-div"),t=p.querySelector('[name="name"]'),a=p.querySelector('[name="phone"]'),o=p.querySelector('[type="checkbox" ]');if(re([e,t,a,o]))return!1;let r={name:t.value,phone:a.value};console.log("params",r)};window.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".footer-city-button"),t=document.querySelector(".comb__selected"),a=document.querySelector(".main-nav.cities"),o=document.querySelector("#city-contacts"),r=document.querySelector("#addr_foot"),c=document.querySelector(".map-modal"),n=document.querySelector(".map-modal .map"),x=document.querySelector(".photo-modal"),L=document.querySelector(".photo-modal .pic");e.innerHTML=localStorage.getItem("selectedCity")||"Россия",o&&(o.innerHTML=e.innerHTML||"Россия"),A(e.innerHTML);function A(s){let E=se.filter(m=>m.city===s);r.innerHTML="",E&&E.forEach(m=>{r.innerHTML+=`
            <div class="address">
                <a href="javascript:openMap('${m.map}')">
                ${m.address}
                </a>
            </div>`})}window.setCity=function(s){A(s),localStorage.setItem("selectedCity",s),a.style.transform="translateX(150vw)",t.innerHTML=e.innerHTML=s,o&&(o.innerHTML=s)},c&&(window.openMap=function(s){c.style.display=s?"grid":"none",n.innerHTML=`<iframe src="${s}" width="100%" height="720" frameborder="0"></iframe>`},window.openPhoto=function(s){x&&(x.style.display=s?"grid":"none"),L&&(L.innerHTML=`<img src ="${s}">`)},document.addEventListener("keydown",s=>{s.key==="Escape"&&c&&(window.openMap(!1),window.openPhoto(!1))}))});export{Te as A,Pe as B,oe as C,ge as a,g as b,re as c,pe as d,we as e,ve as f,me as g,ke as h,V as i,qe as j,se as k,be as l,S as m,ye as n,le as o,ue as p,ne as q,fe as r,ae as s,_e as t,Ae as u,Se as v,Le as w,xe as x,Ee as y,he as z};
