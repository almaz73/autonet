(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))r(c);new MutationObserver(c=>{for(const s of c)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function t(c){const s={};return c.integrity&&(s.integrity=c.integrity),c.referrerPolicy&&(s.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?s.credentials="include":c.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(c){if(c.ep)return;c.ep=!0;const s=t(c);fetch(c.href,s)}})();const $e={events:{},on(e,o){this.events[e]||(this.events[e]=[]),this.events[e].push(o)},emit(e,o){this.events[e]&&this.events[e].forEach(t=>t(o))},off(e,o){this.events[e]&&(this.events[e]=this.events[e].filter(t=>t!==o))}};let Pe={brandsIds:[],modelsIds:[],gearboxTypes:[],engineTypes:[],driveTypes:[],wheelTypes:[],bodyTypes:[],bodyColors:[]};function w(e){return parseInt(e).toLocaleString("ru-RU")}function Me(e){let o=[];return e&&e.forEach(t=>{let r=w(t.milleage)+" км, ";t.engineCapacity&&(r+=t.engineCapacity),t.gearboxType&&(r+=" "+t.gearboxType),t.enginePower&&(r+=" ("+t.enginePower+"&nbsp;л.с)"),t.bodyType&&(r+=", "+t.bodyType),r+=", "+t.driveType,t.engineType&&(r+=", "+t.engineType);let c=w(parseInt(parseInt(t.price.replace(/ /g,""))/90.12));o.push({address:t.fullAddress,id:t.id,name:t.brand+" "+t.model,href:"/cars/car.html?id="+t.id,price:w(t.price),fromPerMonth:c,info:r,photos:t.images,yearReleased:t.yearReleased})}),o}function pe(e,o){const t=[2,0,1,1,1,2];return o[e%100>4&&e%100<20?2:t[e%10<5?e%10:5]]}function Ie(e){return new URLSearchParams(window.location.search).get(e)}function ke(e){let o=document.querySelector(".coin");e===!1&&(o.querySelector("span").title="По возрастанию",o.querySelector("img").style.transform="rotate(180deg)"),e===null&&(o.querySelector("span").title="Не упорядоченно",o.querySelector("img").style.transform="rotate(270deg)"),e===!0&&(o.querySelector("span").title="По убыванию",o.querySelector("img").style.transform="rotate(0deg)")}const fe=function(e){let o=e.value;if(!o)return"";let t=o.replace(/\D/g,""),r="";if(o.length<2)return t;["7","8","9"].indexOf(t[0])>-1?(t[0]==="9"&&(t="7"+t),r=(t[0]==="8"?"8":"+7")+" ",t.length>1&&(r+="("+t.substring(1,4)),t.length>=5&&(r+=") "+t.substring(4,7)),t.length>=8&&(r+="-"+t.substring(7,9)),t.length>=10&&(r+="-"+t.substring(9,11))):r=t.substring(0,11),e.value=r};window.formattingPhone=fe;const ye=function(e){return e?(e.slice(0,2)==="+7"&&(e=e.replaceAll("+7","8")),e.replaceAll(" ","").replaceAll("+","").replaceAll("(","").replaceAll(")","").replaceAll("-","")):""},me=function(e){if(!/^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu.test(e)&&e)return sendMessage("Ошибочный Email ","error")};function te(e){let o=!1,t=!1;return e.forEach(r=>{if(r&&r.required){let c=function(){r.style.background="",r.removeEventListener("change",c)};r.style.border=r.value?"":"1px solid red",r.value||(o=!0),r.addEventListener("change",c)}if(r&&r.classList.contains("capctha-div")&&!r.classList.contains("checked")&&(r.style.border="1px solid red",o=!0),r&&r.type==="checkbox"){let c=r.checked;r.parentNode.style.border=c?"":"1px solid red",c||(o=!0),t=o}r&&r.classList.contains("attent")&&(r.style.display=t?"block":"none"),r&&r.name==="email"&&r.value&&me(r.value)&&(o=!0),r&&r.name==="phone"&&r.value&&ye(r.value).length!==11&&(sendMessage("Телефон неправильный","warning"),r.style.border="1px solid red",o=!0)}),o&&sendMessage("Заполните обязательные поля","warning"),o}function De(){document.querySelectorAll(".with_sub_field").forEach(o=>{let t=o.querySelector(".with_sub_field .select");t.querySelectorAll(".field").forEach(c=>{c.addEventListener("click",s=>r(s.target.innerHTML))});function r(c){t.querySelectorAll(".field").forEach(s=>{s&&s.classList.contains("active")&&s.classList.remove("active")}),t.querySelectorAll(".field").forEach(s=>{s&&s.innerHTML===c&&s.classList.add("active")}),o.querySelector("input").value=c}o.addEventListener("click",()=>{let c=t.style.display!=="block";t.style.display=c?"block":"none"})})}function he(e,o,t,r,c){r=r||"Отправить заявку",c=c||"_ _ _ _ _ _ ";let s=parseInt(Math.random()*1e3),i=`<div class="wrap ${e}"><h3>${c}</h3><div><div class="formBlock">`,d={name:"Имя","name*":"Ваше имя *",year:"Год выпуска","year*":"Год выпуска *",city:"Город","city*":"Город *",price:"Цена",brand:"Марка","brand*":"Марка *",model:"Модель","model*":"Модель *",phone:"Телефон","phone*":"Ваш телефон *",message:"Сообщение","message*":"Сообщение *",email:"E-mail","email*":"E-mail *",osago:"ОСАГО",select:"Выберите услугу"};return o.forEach(l=>{let p=l.includes("*"),a=p?l.slice(0,-1):l;l==="osago"?i+=`<div class="form__modal--group" style="position: relative">
                        ...
                        </div>`:l==="select"?i+=`<div class="form__modal--group">                
                <div class="form__group with_sub_field">
            ...
            </div>`:i+=`<div class="form__modal--group">
                <div class="form__group">
                  <input name="${a}" ${p?"required":""} autocomplete="off" placeholder="${d[l]}" 
${a==="phone"?'oninput="formattingPhone(this)"':""}>
                </div>
            </div>`}),i+=`
...
`),fetch(ie+o,{method:"POST",headers:{"Content-Type":"application/json;charset=utf-8"},body:JSON.stringify({type:e.type||10,text:t})}).then(r=>r.json()).then(r=>r).catch(()=>sendMessage("Сервер не принял письмо!","error"))}function Fe(e){let o="/api/Email/PostEmailWithAttachement";const t=new FormData;t.append("type",11);let r="";return(e.fio||e.name)&&(r+="Имя: "+(e.fio||e.name)+`
`),e.phone&&(r+="Телефон: "+e.phone+`
`),e.city&&(r+="Город: "+e.city+`
`),e.email&&(r+="Email: "+e.email+`
`),e.aboutYourself&&(r+="О себе: "+e.aboutYourself+`
`),t.append("text",r),t.append("file",e.resume),fetch(ie+o,{method:"POST",body:t}).then(c=>c.json()).then(c=>c).catch(()=>sendMessage("Сервер отказал!","error"))}function je(e,o){let t="/api/Auto/GetList?Limit="+e.limit;return e.brandId&&(t+="&brandId="+e.brandId),e.modelId&&(t+="&modelId="+e.modelId),e.offset&&(t+="&offset="+e.offset),e.priceOrder!==null&&e.priceOrder!==void 0&&(t+="&priceOrder="+e.priceOrder),e.city&&e.city!=="Все"&&(t+="&city="+e.city),e.gearboxType&&(t+="&gearboxType="+e.gearboxType),e.engineType&&(t+="&engineType="+e.engineType),e.driveType&&(t+="&driveType="+e.driveType),e.wheelType&&(t+="&wheelType="+e.wheelType),e.bodyType&&(t+="&bodyType="+e.bodyType),e.colorId&&(t+="&colorId="+e.colorId),e.yearReleasedFrom&&(t+="&yearReleasedFrom="+e.yearReleasedFrom),e.yearReleasedTo&&(t+="&yearReleasedTo="+e.yearReleasedTo),e.priceTo&&(t+="&priceTo="+e.priceTo),e.priceFrom&&(t+="&priceFrom="+e.priceFrom),e.milleageFrom&&(t+="&milleageFrom="+e.milleageFrom),e.milleageTo&&(t+="&milleageTo="+e.milleageTo),e.engineCapacity&&(t+="&engineCapacity="+e.engineCapacity),u(t,o,null)}function Ke(e,o){let t="/api/Auto/GetSpecials?city="+e;return u(t,o,60)}function Ge(e,o){let t="/api/Auto/GetFullAutoInfo?guid="+e;return u(t,o,10)}function Ve(e){return u("/api/Auto/GetCarCount",e,5)}function ze(e){return u("/api/auto/getBrandList",e,60)}function Ye(e,o){let t="/api/auto/getModelList?brandId="+e;return u(t,o,60)}function Je(e){return u("/api/Auto/GetCities",e,60)}function Ue(e){return u("/api/Auto/GetGearboxTypes",e,60)}function We(e){return u("/api/Auto/GetEngineTypes",e,60)}function Ze(e){return u("/api/Auto/getDriveTypes",e,60)}function Qe(e){return u("/api/Auto/getWheelTypes",e,60)}function et(e){return u("/api/Auto/getBodyTypes",e,60)}function tt(e){return u("/api/Auto/GetYearGap",e,60)}function ot(e){return u("/api/Auto/GetColorList",e,60)}let Ce=document.querySelector(".global-call"),xe=document.querySelector("#right_panel_content");Ce.addEventListener("click",()=>{openRightPanel(),xe.innerHTML=he("globC",["name*","phone*"],"sendBid","Отправить заявку","Заказать звонок"),$()});window.sendBid=function(e){const o=document.querySelector(`.${e} .capctha-div`),t=document.querySelector(`.${e} [name="name"]`),r=document.querySelector(`.${e} [name="phone"]`),c=document.querySelector(`.${e} [name="email"]`),s=document.querySelector(`.${e} [name="city"]`),i=document.querySelector(`.${e} [name="brand"]`),d=document.querySelector(`.${e} [name="model"]`),l=document.querySelector(`.${e} [name="year"]`),p=document.querySelector(`.${e} [type="checkbox"]`),a=document.querySelector(`.${e} button`);if(te([o,t,r,p]))return!1;const b={type:1,name:t.value,phone:r.value,email:c&&c.value,city:s&&s.value,brand:i&&i.value,model:d&&d.value,year:l&&l.value};showPreloader(!0,a),ae(b).then(h=>{h&&(setTimeout(()=>sendMessage("Ваша заявка успешно отправлена"),500),document.querySelector(`.${e} .formBlock`).innerHTML="<br>Спасибо! Ваша заявка успешно отправлена, в ближайшее время мы выйдем с Вами на связь.<br><br><br>"),showPreloader(!1,a)})};$();window.sendBidPromo=function(){const e=document.querySelector(".capctha-div"),o=document.querySelector('[name="name"]'),t=document.querySelector('[name="year"]'),r=document.querySelector('[type="checkbox"]'),c=document.querySelector("button");if(te([e,o,r]))return!1;const s={type:16,name:o.value,year:t.value};showPreloader(!0,c),ae(s).then(i=>{i&&(setTimeout(()=>sendMessage("Ваша заявка успешно отправлена"),500),document.querySelector(".formBlock").innerHTML="<br>Спасибо! Ваша заявка успешно отправлена, в ближайшее время мы выйдем с Вами на связь.<br><br><br>"),showPreloader(!1,c)})};window.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".footer-city-button"),o=document.querySelector(".comb__selected"),t=document.querySelector(".main-nav.cities"),r=document.querySelector("#city-contacts"),c=document.querySelector("#addr_foot"),s=document.querySelector(".map-modal"),i=document.querySelector(".map-modal .map"),d=document.querySelector(".photo-modal"),l=document.querySelector(".photo-modal .pic");e.innerHTML=localStorage.getItem("selectedCity")||"Россия",r&&(r.innerHTML=e.innerHTML||"Россия"),p(e.innerHTML);function p(a){console.log("cityName",a);let b=be.filter(h=>h.city===a);c.innerHTML="",b&&b.forEach(h=>{c.innerHTML+=`
            <div class="address">
                <a href="javascript:openMap('${h.map}')">
                ${h.address}
                </a>
            </div>`}),console.log("999"),console.log("999 getVitrina",window.getVitrina),window.getVitrina&&getVitrina()}window.setCity=function(a){p(a),localStorage.setItem("selectedCity",a),t.style.transform="translateX(150vw)",o.innerHTML=e.innerHTML=a,r&&(r.innerHTML=a)},s&&(window.openMap=function(a){s.style.display=a?"grid":"none",i.innerHTML=`<iframe src="${a}" width="100%" height="720" frameborder="0"></iframe>`},window.openPhoto=function(a){d&&(d.style.display=a?"grid":"none"),l&&(l.innerHTML=`<img alt="" src ="${a}">`)},document.addEventListener("keydown",a=>{a.key==="Escape"&&s&&(window.openMap(!1),window.openPhoto(!1))}))});window.addCompare=function(e){let o=window.compareCars.find(d=>d.id===e),t=P(),r=o;o.images&&(r.images=o.images[0]);let c=document.querySelector("#compareId_"+e),s=c.classList.contains("chosen"),i=t.find(d=>d.id===e);s?(c.classList.remove("chosen"),t=t.filter(d=>d.id!==r.id)):(c.classList.add("chosen"),i||t.push(r)),localStorage.setItem("ComparedCars",JSON.stringify(t)),M(t)};function P(){let e=localStorage.getItem("ComparedCars");return e?e=JSON.parse(e):e=[],e}function M(e){let o=document.querySelector("#compareCount");o&&e.length?(o.innerHTML='<img src="/icons/car-icon_b.svg">'+e.length,o.style.display="flex"):o&&(o.style.display="none")}window.deleteAllCar=function(){window.deleteCar()};window.deleteCar=function(e){let o=P();if(e?o=o.filter(t=>t.id!==e):o=[],localStorage.setItem("ComparedCars",JSON.stringify(o)),M(o),de(o),!o.length){let t=document.querySelector(".compare-clear");t&&(t.style.display="none")}};function de(e){let o=e||P();if(M(o),o.forEach(t=>{let r=document.querySelector("#compareId_"+t.id);r&&r.classList.add("chosen")}),location.pathname==="/personal/list-compared/"){let t=document.querySelector("#compare-field"),r="",c="",s="",i="",d="",l="",p="",a="",b="",h="",D="",O="",R="",B="",N="",X="";o.forEach(n=>{if(n.photos&&(n.images=n.photos[0]),n.address&&(n.fullAddress=n.address),n.name&&(n.brand=n.name.split(" ")[0],n.model=n.name.split(" ")[1]),n.info){let v=n.info.split(",");console.log(v),n.milleage=parseInt(v[0].replace(/\s/g,"")),n.engineCapacity=v[1],n.bodyType=v[2],n.driveType=v[3],n.engineType=v[4]}r+=`<td><a href="javascript:deleteCar('${n.id}')">Удалить</a></td>`,c+=`<td><a href="/cars/car.html?id=${n.id}"><img src="${n.images}" alt=""></a></td>`,s+=`<td><a href="/cars/car.html?id=${n.id}">"${n.brand} ${n.model}</a></td>`,i+=`<td>${w(n.price)} руб.</td>`,n.milleage&&(d+=`<td>${w(n.milleage)||""} км</td>`),l+=`<td>${n.yearReleased||""}</td>`,p+=`<td>${n.color||""}</td>`,a+=`<td>${n.engineCapacity||""}</td>`,b+=`<td>${n.engineType||""}</td>`,h+=`<td>${n.enginePower||""}</td>`,D+=`<td>${n.gearboxType||""}</td>`,O+=`<td>${n.driveType||""}</td>`,R+=`<td>${n.bodyType||""}</td>`,B+=`<td>${n.fullAddress||""}</td>`,N+=`<td>${n.brand||""}</td>`,X+=`<td>${n.model||""}</td>`}),t.innerHTML=`
              <tr class="DELETE">
...
</div>`});window.showPreloader=function(e,o){let t=document.querySelector("#preloader");if(!t)return!1;t.style.display=e?"block":"none",o&&(o.style.opacity=e?.5:1,o.disabled=e)};export{Oe as A,ke as B,Ke as C,pe as D,He as E,Fe as F,oe as G,Xe as H,De as I,me as J,tt as a,Ve as b,he as c,te as d,ae as e,Ge as f,Ie as g,w as h,$ as i,be as j,Re as k,ze as l,Je as m,Ue as n,We as o,Me as p,Ze as q,Qe as r,Ne as s,Be as t,et as u,ot as v,$e as w,Pe as x,Ye as y,je as z};
