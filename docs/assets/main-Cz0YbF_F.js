(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))r(c);new MutationObserver(c=>{for(const s of c)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function t(c){const s={};return c.integrity&&(s.integrity=c.integrity),c.referrerPolicy&&(s.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?s.credentials="include":c.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(c){if(c.ep)return;c.ep=!0;const s=t(c);fetch(c.href,s)}})();const $e={events:{},on(e,o){this.events[e]||(this.events[e]=[]),this.events[e].push(o)},emit(e,o){this.events[e]&&this.events[e].forEach(t=>t(o))},off(e,o){this.events[e]&&(this.events[e]=this.events[e].filter(t=>t!==o))}};let Me={brandsIds:[],modelsIds:[],gearboxTypes:[],engineTypes:[],driveTypes:[],wheelTypes:[],bodyTypes:[],bodyColors:[]};function w(e){return parseInt(e).toLocaleString("ru-RU")}function Pe(e){let o=[];return e&&e.forEach(t=>{let r=w(t.milleage)+" км, ";t.engineCapacity&&(r+=t.engineCapacity),t.gearboxType&&(r+=" "+t.gearboxType),t.enginePower&&(r+=" ("+t.enginePower+"&nbsp;л.с)"),t.bodyType&&(r+=", "+t.bodyType),r+=", "+t.driveType,t.engineType&&(r+=", "+t.engineType);let c=w(parseInt(parseInt(t.price.replace(/ /g,""))/90.12));o.push({address:t.fullAddress,id:t.id,name:t.brand+" "+t.model,href:"/cars/car.html?id="+t.id,price:w(t.price),fromPerMonth:c,info:r,photos:t.images,yearReleased:t.yearReleased})}),o}function pe(e,o){const t=[2,0,1,1,1,2];return o[e%100>4&&e%100<20?2:t[e%10<5?e%10:5]]}function Ie(e){return new URLSearchParams(window.location.search).get(e)}function ke(e){let o=document.querySelector(".coin");e===!1&&(o.querySelector("span").title="По возрастанию",o.querySelector("img").style.transform="rotate(180deg)"),e===null&&(o.querySelector("span").title="Не упорядоченно",o.querySelector("img").style.transform="rotate(270deg)"),e===!0&&(o.querySelector("span").title="По убыванию",o.querySelector("img").style.transform="rotate(0deg)")}const fe=function(e){let o=e.value;if(!o)return"";let t=o.replace(/\D/g,""),r="";if(o.length<2)return t;["7","8","9"].indexOf(t[0])>-1?(t[0]==="9"&&(t="7"+t),r=(t[0]==="8"?"8":"+7")+" ",t.length>1&&(r+="("+t.substring(1,4)),t.length>=5&&(r+=") "+t.substring(4,7)),t.length>=8&&(r+="-"+t.substring(7,9)),t.length>=10&&(r+="-"+t.substring(9,11))):r=t.substring(0,11),e.value=r};window.formattingPhone=fe;const ye=function(e){return e?(e.slice(0,2)==="+7"&&(e=e.replaceAll("+7","8")),e.replaceAll(" ","").replaceAll("+","").replaceAll("(","").replaceAll(")","").replaceAll("-","")):""},me=function(e){if(!/^(([^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*)|(".+"))@(([^<>()[\].,;:\s@"]+\.)+[^<>()[\].,;:\s@"]{2,})$/iu.test(e)&&e)return sendMessage("Ошибочный Email ","error")};function te(e){let o=!1,t=!1;return e.forEach(r=>{if(r&&r.required){let c=function(){r.style.background="",r.removeEventListener("change",c)};r.style.border=r.value?"":"1px solid red",r.value||(o=!0),r.addEventListener("change",c)}if(r&&r.classList.contains("capctha-div")&&!r.classList.contains("checked")&&(r.style.border="1px solid red",o=!0),r&&r.type==="checkbox"){let c=r.checked;r.parentNode.style.border=c?"":"1px solid red",c||(o=!0),t=o}r&&r.classList.contains("attent")&&(r.style.display=t?"block":"none"),r&&r.name==="email"&&r.value&&me(r.value)&&(o=!0),r&&r.name==="phone"&&r.value&&ye(r.value).length!==11&&(sendMessage("Телефон неправильный","warning"),r.style.border="1px solid red",o=!0)}),o&&sendMessage("Заполните обязательные поля","warning"),o}function De(){document.querySelectorAll(".with_sub_field").forEach(o=>{let t=o.querySelector(".with_sub_field .select");t.querySelectorAll(".field").forEach(c=>{c.addEventListener("click",s=>r(s.target.innerHTML))});function r(c){t.querySelectorAll(".field").forEach(s=>{s&&s.classList.contains("active")&&s.classList.remove("active")}),t.querySelectorAll(".field").forEach(s=>{s&&s.innerHTML===c&&s.classList.add("active")}),o.querySelector("input").value=c}o.addEventListener("click",()=>{let c=t.style.display!=="block";t.style.display=c?"block":"none"})})}function he(e,o,t,r,c){r=r||"Отправить заявку",c=c||"_ _ _ _ _ _ ";let s=parseInt(Math.random()*1e3),a=`<div class="wrap ${e}"><h3>${c}</h3><div><div class="formBlock">`,d={name:"Имя","name*":"Ваше имя *",year:"Год выпуска","year*":"Год выпуска *",city:"Город","city*":"Город *",price:"Цена",brand:"Марка","brand*":"Марка *",model:"Модель","model*":"Модель *",phone:"Телефон","phone*":"Ваш телефон *",message:"Сообщение","message*":"Сообщение *",email:"E-mail","email*":"E-mail *",osago:"ОСАГО",select:"Выберите услугу"};return o.forEach(u=>{let m=u.includes("*"),n=m?u.slice(0,-1):u;u==="osago"?a+=`<div class="form__modal--group" style="position: relative">
                        ...
                        </div>`:u==="select"?a+=`<div class="form__modal--group">                
                <div class="form__group with_sub_field">
                ...
                <div class="form__group">
                  <input name="${n}" ${m?"required":""} autocomplete="off" placeholder="${d[u]}" 
...
<div class="form__modal--group">
            ...
            <div class="modal__personal">
             ...
             `}],He=[{address:"Альметьевск , Герцена 1Б",id:210,type:"tyres",winter:!0,name:"Viatti Brina Nordico 225/45 R17 Зима шип ",href:"/cars/2106/651138/",price:"15 000",info:"",photos:["/photo-tyres/1/NK0_03b04be8_00002.jpg","/photo-tyres/1/NK0_351bedd2_00002.jpg","/photo-tyres/1/NK0_351bedd2_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg"]},{address:"Альметьевск , Герцена 1Б",id:211,type:"tyres",name:"Viatti Brina Nordico 225/45 R17 Зима шип ",href:"/cars/2106/651138/",price:"21 091",info:"",photos:["/photo-tyres/1/NK0_351bedd2_00002.jpg","/photo-tyres/1/NK0_03b04be8_00002.jpg","/photo-tyres/1/NK0_351bedd2_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg"]},{address:"Альметьевск , Герцена 1Б",id:212,type:"tyres",winter:!0,name:"Viatti Brina Nordico 225/45 R17 Зима шип ",href:"/cars/2106/651138/",price:"15 000",info:"",photos:["/photo-tyres/1/NK0_351bedd2_00003.jpg","/photo-tyres/1/NK0_03b04be8_00002.jpg","/photo-tyres/1/NK0_351bedd2_00002.jpg","/photo-tyres/1/NK0_ff8cd2b6_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg"]},{address:"Альметьевск , Герцена 1Б",id:213,type:"tyres",winter:!0,name:"Viatti Brina Nordico 225/45 R17 Зима шип ",href:"/cars/2106/651138/",price:"21 091",info:"",photos:["/photo-tyres/1/NK0_ff8cd2b6_00003.jpg","/photo-tyres/1/NK0_03b04be8_00002.jpg","/photo-tyres/1/NK0_351bedd2_00002.jpg","/photo-tyres/1/NK0_351bedd2_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00004.jpg"]},{address:"Альметьевск , Герцена 1Б",id:214,type:"tyres",name:"Viatti Brina Nordico 225/45 R17 Зима шип ",href:"/cars/2106/651138/",price:"15 000",info:"",photos:["/photo-tyres/1/NK0_ff8cd2b6_00004.jpg","/photo-tyres/1/NK0_03b04be8_00002.jpg","/photo-tyres/1/NK0_351bedd2_00002.jpg","/photo-tyres/1/NK0_351bedd2_00003.jpg","/photo-tyres/1/NK0_ff8cd2b6_00003.jpg"]}];let v=document.querySelector(".comb__items"),F=document.querySelector(".comb_field"),re=document.querySelector(".comb__selected"),ge=document.querySelector(".footer-city-button"),H=document.querySelector("#city-contacts"),j=document.querySelector(".comb_field img"),K=document.querySelector(".mySwiper"),ve=localStorage.getItem("selectedCity");v.innerHTML="";oe.forEach(e=>v.innerHTML+=`<div class="comb__item">${e}</div>`);F&&(re.innerHTML=ve||"Россия",document.addEventListener("click",()=>ce(!1)),F.addEventListener("click",e=>we(e)),v.addEventListener("click",e=>_e(e)));function _e(e){let o=e.target.innerText;if(o.length>30)return!1;re.innerHTML=ge.innerHTML=o,H&&(H.innerHTML=o),localStorage.setItem("selectedCity",o),window.setCity&&window.setCity(o)}function we(e){ce(v.style.display!=="block"),e.stopPropagation()}function ce(e){v&&(v.style.display=e?"block":"none"),j&&(j.style.rotate=e?"180deg":"0deg"),K&&(K.style.zIndex=e?-1:0)}let Se=document.querySelector("#innerCity"),C=document.querySelector(".form__modal-place--group input"),Le=["А","Б","Е","К","М","Н","О","С","Т","У"];function se(e){let o="";Le.forEach(t=>{let r=oe.filter(s=>s.slice(0,1)===t),c="";r.forEach(s=>{let a=e&&s.toUpperCase().includes(e)?" class='yel'":"";c+=`<li><a href="javascript:void(0)" onclick="setCity('${s}')"><span ${a}>${s}</span></a></li>`}),o+=`<div class="modal-place__box">
<div><div class="letter">${t}</div><ul>${c}</ul></div></div>`}),Se.innerHTML=o}C&&C.addEventListener("input",e=>{se(C.value.toUpperCase())});let G=document.querySelector(".button__burger"),T=document.querySelector(".main-nav.menu"),E=document.querySelector(".button__burger"),b=document.querySelector(".main-nav.cities"),V=document.querySelector(".footer-city-button"),z=document.querySelector("#city-contacts"),Y=document.querySelector(".modal-place__close"),J=document.querySelector(".mySwiper"),f,A=document.querySelector(".main-nav.rightpanel"),U=document.querySelector("#closer-fon"),W=document.querySelector(".modal-closer.form");J&&(J.style.zIndex=0);G&&G.addEventListener("click",()=>{if(f)return f=!1,b.style.transform="translateX(150vw)",!1;f=T.style.transform!=="none",T.style.transform=f?"none":"translateX(150vw)",f?(E.classList.add("close"),f=!1):E.classList.remove("close")});V&&V.addEventListener("click",()=>ie());z&&z.addEventListener("click",()=>ie());function ie(){f=b.style.transform!=="none",f&&(b.style.transform="none",b.style.backgroundColor="white"),se()}Y&&Y.addEventListener("click",()=>{b.style.transform="translateX(150vw)"});let Z=document.querySelector("#cookie-accept"),x=document.querySelector("#cookie-banner"),Te=localStorage.getItem("isCoockieBannerShow");!Te&&x&&x.classList.add("show");Z&&Z.addEventListener("click",()=>{localStorage.setItem("isCoockieBannerShow",new Date().toISOString()),x.classList.remove("show")});function q(e){A&&(A.style.transform="translateX(150vw)"),b&&(b.style.transform="translateX(150vw)"),T&&(T.style.transform="translateX(150vw)"),E&&E.classList.remove("close")}window.close_all=q;document.addEventListener("keydown",e=>e.key==="Escape"&&q());window.openRightPanel=function(){f=A.style.transform!=="none",f&&(A.style.transform="none")};U&&U.addEventListener("click",()=>q());W&&W.addEventListener("click",()=>q());const p=document.getElementById("mainPhoto");p&&p.addEventListener("click",function(){if(window.innerWidth<900)return!1;p.requestFullscreen?p.requestFullscreen():p.mozRequestFullScreen?p.mozRequestFullScreen():p.webkitRequestFullscreen?p.webkitRequestFullscreen():p.msRequestFullscreen&&p.msRequestFullscreen()});document.addEventListener("DOMContentLoaded",()=>{window.reloadAbdul()});window.reloadAbdul=function(){let e=document.querySelector("abdul");e&&(e.innerHTML=Ee)};const Ee=`
...
`),t.append("text",r),t.append("resume",e.resume),fetch(ae+o,{method:"POST",body:t}).then(c=>c.json()).then(c=>c).catch(()=>sendMessage("Сервер отказал!","error"))}function Ke(e,o){let t="/api/Auto/GetList?Limit="+e.limit;return e.brandId&&(t+="&brandId="+e.brandId),e.modelId&&(t+="&modelId="+e.modelId),e.offset&&(t+="&offset="+e.offset),e.priceOrder!==null&&e.priceOrder!==void 0&&(t+="&priceOrder="+e.priceOrder),e.city&&e.city!=="Все"&&(t+="&city="+e.city),e.gearboxType&&(t+="&gearboxType="+e.gearboxType),e.engineType&&(t+="&engineType="+e.engineType),e.driveType&&(t+="&driveType="+e.driveType),e.wheelType&&(t+="&wheelType="+e.wheelType),e.bodyType&&(t+="&bodyType="+e.bodyType),e.colorId&&(t+="&colorId="+e.colorId),e.yearReleasedFrom&&(t+="&yearReleasedFrom="+e.yearReleasedFrom),e.yearReleasedTo&&(t+="&yearReleasedTo="+e.yearReleasedTo),e.priceTo&&(t+="&priceTo="+e.priceTo),e.priceFrom&&(t+="&priceFrom="+e.priceFrom),e.milleageFrom&&(t+="&milleageFrom="+e.milleageFrom),e.milleageTo&&(t+="&milleageTo="+e.milleageTo),e.engineCapacity&&(t+="&engineCapacity="+e.engineCapacity),l(t,o,null)}function Ge(e,o){let t="/api/Auto/GetSpecials?city="+e;return l(t,o,60)}function Ve(e,o){let t="/api/Auto/GetFullAutoInfo?guid="+e;return l(t,o,10)}function ze(e){return l("/api/Auto/GetCarCount",e,5)}function Ye(e){return l("/api/auto/getBrandList",e,60)}function Je(e,o){let t="/api/auto/getModelList?brandId="+e;return l(t,o,60)}function Ue(e){return l("/api/Auto/GetCities",e,60)}function We(e){return l("/api/Auto/GetGearboxTypes",e,60)}function Ze(e){return l("/api/Auto/GetEngineTypes",e,60)}function Qe(e){return l("/api/Auto/getDriveTypes",e,60)}function et(e){return l("/api/Auto/getWheelTypes",e,60)}function tt(e){return l("/api/Auto/getBodyTypes",e,60)}function ot(e){return l("/api/Auto/GetYearGap",e,60)}function rt(e){return l("/api/Auto/GetColorList",e,60)}let Ce=document.querySelector(".global-call"),xe=document.querySelector("#right_panel_content");Ce.addEventListener("click",()=>{openRightPanel(),xe.innerHTML=he("globC",["name*","phone*"],"sendBid","Отправить заявку","Заказать звонок"),$()});window.sendBid=function(e){let o=document.querySelector(`.${e} .capctha-div`),t=document.querySelector(`.${e} [name="name"]`),r=document.querySelector(`.${e} [name="phone"]`),c=document.querySelector(`.${e} [name="email"]`),s=document.querySelector(`.${e} [type="checkbox" ]`);if(te([o,t,r,s]))return!1;let a={type:1,name:t.value,phone:r.value,email:c.value};ne(a).then(d=>{d&&(setTimeout(()=>sendMessage("Ваша заявка успешно отправлена"),500),document.querySelector(`.${e} .formBlock`).innerHTML="<br>Спасибо! Ваша заявка успешно отправлена, в ближайшее время мы выйдем с Вами на связь.<br><br><br>")})};$();window.sendBidPromo=function(){let e=document.querySelector(".capctha-div"),o=document.querySelector('[name="name"]'),t=document.querySelector('[name="year"]'),r=document.querySelector('[type="checkbox" ]');if(te([e,o,r]))return!1;let c={type:16,name:o.value,year:t.value};ne(c).then(s=>{s&&(setTimeout(()=>sendMessage("Ваша заявка успешно отправлена"),500),document.querySelector(".formBlock").innerHTML="<br>Спасибо! Ваша заявка успешно отправлена, в ближайшее время мы выйдем с Вами на связь.<br><br><br>")})};window.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector(".footer-city-button"),o=document.querySelector(".comb__selected"),t=document.querySelector(".main-nav.cities"),r=document.querySelector("#city-contacts"),c=document.querySelector("#addr_foot"),s=document.querySelector(".map-modal"),a=document.querySelector(".map-modal .map"),d=document.querySelector(".photo-modal"),u=document.querySelector(".photo-modal .pic");e.innerHTML=localStorage.getItem("selectedCity")||"Россия",r&&(r.innerHTML=e.innerHTML||"Россия"),m(e.innerHTML);function m(n){let _=be.filter(h=>h.city===n);c.innerHTML="",_&&_.forEach(h=>{c.innerHTML+=`
            <div class="address">
                <a href="javascript:openMap('${h.map}')">
                ${h.address}
                </a>
            </div>`}),window.getVitrina&&getVitrina()}window.setCity=function(n){m(n),localStorage.setItem("selectedCity",n),t.style.transform="translateX(150vw)",o.innerHTML=e.innerHTML=n,r&&(r.innerHTML=n)},s&&(window.openMap=function(n){s.style.display=n?"grid":"none",a.innerHTML=`<iframe src="${n}" width="100%" height="720" frameborder="0"></iframe>`},window.openPhoto=function(n){d&&(d.style.display=n?"grid":"none"),u&&(u.innerHTML=`<img alt="" src ="${n}">`)},document.addEventListener("keydown",n=>{n.key==="Escape"&&s&&(window.openMap(!1),window.openPhoto(!1))}))});window.addCompare=function(e){let o=window.compareCars.find(d=>d.id===e),t=M(),r=o;o.images&&(r.images=o.images[0]);let c=document.querySelector("#compareId_"+e),s=c.classList.contains("chosen"),a=t.find(d=>d.id===e);s?(c.classList.remove("chosen"),t=t.filter(d=>d.id!==r.id)):(c.classList.add("chosen"),a||t.push(r)),localStorage.setItem("ComparedCars",JSON.stringify(t)),P(t)};function M(){let e=localStorage.getItem("ComparedCars");return e?e=JSON.parse(e):e=[],e}function P(e){let o=document.querySelector("#compareCount");o&&e.length?(o.innerHTML='<img src="/icons/car-icon_b.svg">'+e.length,o.style.display="flex"):o&&(o.style.display="none")}window.deleteAllCar=function(){window.deleteCar()};window.deleteCar=function(e){let o=M();if(e?o=o.filter(t=>t.id!==e):o=[],localStorage.setItem("ComparedCars",JSON.stringify(o)),P(o),de(o),!o.length){let t=document.querySelector(".compare-clear");t&&(t.style.display="none")}};function de(e){let o=e||M();if(P(o),o.forEach(t=>{let r=document.querySelector("#compareId_"+t.id);r&&r.classList.add("chosen")}),location.pathname==="/personal/list-compared/"){let t=document.querySelector("#compare-field"),r="",c="",s="",a="",d="",u="",m="",n="",_="",h="",D="",O="",N="",R="",B="",X="";o.forEach(i=>{if(i.photos&&(i.images=i.photos[0]),i.address&&(i.fullAddress=i.address),i.name&&(i.brand=i.name.split(" ")[0],i.model=i.name.split(" ")[1]),i.info){let g=i.info.split(",");console.log(g),i.milleage=parseInt(g[0].replace(/\s/g,"")),i.engineCapacity=g[1],i.bodyType=g[2],i.driveType=g[3],i.engineType=g[4]}r+=`<td><a href="javascript:deleteCar('${i.id}')">Удалить</a></td>`,c+=`<td><a href="/cars/car.html?id=${i.id}"><img src="${i.images}" alt=""></a></td>`,s+=`<td><a href="/cars/car.html?id=${i.id}">"${i.brand} ${i.model}</a></td>`,a+=`<td>${w(i.price)} руб.</td>`,i.milleage&&(d+=`<td>${w(i.milleage)||""} км</td>`),u+=`<td>${i.yearReleased||""}</td>`,m+=`<td>${i.color||""}</td>`,n+=`<td>${i.engineCapacity||""}</td>`,_+=`<td>${i.engineType||""}</td>`,h+=`<td>${i.enginePower||""}</td>`,D+=`<td>${i.gearboxType||""}</td>`,O+=`<td>${i.driveType||""}</td>`,N+=`<td>${i.bodyType||""}</td>`,R+=`<td>${i.fullAddress||""}</td>`,B+=`<td>${i.brand||""}</td>`,X+=`<td>${i.model||""}</td>`}),t.innerHTML=`
              <tr class="DELETE">
            ...
            <tr class="MODEL">
                <td>Модель</td>
                ${X}
            </tr>`,o.length||(t.innerHTML='<div class="nodata">НЕТ ВЫБРАННЫХ АВТОМОБИЛЕЙ ДЛЯ СРАВНЕНИЯ</div>')}}function le(){let e=!1,o,t=document.querySelector(".bx_compare");t&&(t.addEventListener("mousedown",c=>{e=!0,o=c.clientX,c.preventDefault()}),t.addEventListener("mousemove",c=>{e&&(t.scrollBy(o-c.clientX,0),o=c.clientX)}),t.addEventListener("mouseup",()=>e=!1)),de();let r=document.querySelector("#preload_getList");r&&(r.style.display="none")}window.initChosen=le;setTimeout(le);window.dblCompare=function(){location.href="/personal/list-compared/"};window.addFavorite=function(e){let o=window.favorCars&&window.favorCars.find(a=>a.id===e),t=k(),r=document.querySelector("#favoriteId_"+e),c=r.classList.contains("chosen"),s=t.find(a=>a&&a.id===e);c?location.pathname==="/personal/favorite-cars/"?(r.classList.remove("chosen"),t=t.filter(a=>a.id!==e),localStorage.setItem("FavoriteCars",JSON.stringify(t)),window.getVitrina()):location.href="/personal/favorite-cars/":(r.classList.add("chosen"),s||t.push(o)),t&&(t=t.filter(a=>a),localStorage.setItem("FavoriteCars",JSON.stringify(t)),I(t)),ue(t)};document.addEventListener("DOMContentLoaded",()=>{let e=document.querySelector("#noFavotite"),o=document.querySelector("#noFavotiteDelete");if(!e)return!1;k().length?e.style.display="none":(e.style.display="block",o.style.display="none")});function I(e){(e||k()).forEach(r=>{let c=r&&document.querySelector("#favoriteId_"+r.id);c&&c.classList.add("chosen")});let t=document.querySelector("#preload_getList");t&&(t.style.display="none")}function k(){let e=localStorage.getItem("FavoriteCars");return e?e=JSON.parse(e):e=[],ue(e),e}window.deleteAllFavoriteCar=function(){localStorage.setItem("FavoriteCars",JSON.stringify([])),window.getVitrina()};function ue(e){let o=document.querySelector("#favoriteCount");o&&e.length?(o.innerHTML='<img src="/icons/penta.svg">'+e.length,o.style.display="flex"):o&&(o.style.display="none")}window.initFavotite=I;setTimeout(I);let S=0,L=[];window.sendMessage=function(e,o){let t="green";o==="warning"&&(t="orangered"),o==="error"&&(t="red");let r=document.createElement("div");r.innerText=e,r.classList.add("message-span"),r.style.backgroundColor=t,r.style.top=10+40*S+"px",r.id=S,document.body.appendChild(r),L.push(r),r.addEventListener("click",()=>{r.classList.remove("show"),ee(r.id)}),r.addEventListener("mouseover",()=>{r.stopped=!0}),setTimeout(()=>r.classList.add("show"),100),S++,setTimeout(()=>{r.stopped||(r.style.opacity="0",r.classList.remove("show"),ee(r.id))},3e3)};function ee(e){L=L.filter(o=>o.id!==e),S--,L.forEach((o,t)=>{o.style.top=10+40*t+"px",o.id=t})}export{Ke as A,Ne as B,ke as C,Ge as D,pe as E,He as F,je as G,oe as H,Fe as I,De as J,me as K,ot as a,ze as b,he as c,te as d,ne as e,Ve as f,Ie as g,w as h,$ as i,be as j,Re as k,Ye as l,Ue as m,We as n,Ze as o,Pe as p,Qe as q,et as r,Xe as s,Be as t,tt as u,rt as v,$e as w,Me as x,Je as y,Oe as z};
