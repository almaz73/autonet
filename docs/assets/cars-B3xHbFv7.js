import"./main-D7DCdaCr.js";/* empty css              */import"./brands-icons-B0LeJyEa.js";import{g as s}from"./global-func-BLfbnEIy.js";import"./filter-controls-DyGvlIpf.js";/* empty css                          */import"./swiper_buy-CDu4HQCt.js";import"./swiper-starter-DAQO3WFk.js";import"./favoriteCars-UyRy5S1X.js";import"./compareCars-aUEkwXup.js";const a=`<div  class="filter-white">
...
<!--        </div>-->
    ...
    </div><cards class='cards dot4' data-col='dot4'></cards>`;let e=s("brand");const i=s("id");i||(document.querySelector("#filter_cars").innerHTML=a);i||(document.querySelector("#car-vitrina").innerHTML=t);e&&!i&&(e.includes("/")&&(e=e.split("/")[0]),document.querySelector("#path").innerHTML=e.toUpperCase());i&&console.log("66445",121212);
